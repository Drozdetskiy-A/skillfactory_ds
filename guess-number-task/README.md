...
### Описание проекта    
Компьютер угадывает случайное загаданное число меньше чем за 20 попыток.
...
Данные поступают случайным образом из программы типа int
...
-- Пишем функцию, которая считает количество попыток в среднем за 1000 подходов
...
### Выводы:  
Был получен опыт в модернизации кода программы, под необходимые задачи
